...
abstract class BaseEffect(
    ...
    override fun init(engine: PulseEngineInternal)
    {
        ...
        if (fullscreenPasses.isEmpty())
            programs.forEachFast { fullscreenPasses.add(FullscreenPass(it)) }

        fullscreenPasses.forEachFast { it.init() }
    ...
    override fun destroy()
    {
        ...
        fullscreenPasses.forEachFast { it.destroy() }
        frameBuffers.forEachFast { it.destroy() }
