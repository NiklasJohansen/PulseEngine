...
class DoubleBufferedFloatObject private constructor(
    ...
    fun submit()
    {
        ...
        incrementUploadedBytes(readSize.toLong() * Float.SIZE_BYTES)
    ...
    companion object
    {
        ...
        fun createShaderStorageBuffer(initCapacity: Int = 0, usage: Int = GL_DYNAMIC_DRAW): DoubleBufferedFloatObject
        {
