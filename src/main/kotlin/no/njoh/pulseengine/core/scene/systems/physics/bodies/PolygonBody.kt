package no.njoh.pulseengine.core.scene.systems.physics.bodies
...
import no.njoh.pulseengine.core.scene.systems.physics.ContactSolver
import no.njoh.pulseengine.core.scene.systems.physics.BodyType.STATIC
import no.njoh.pulseengine.core.scene.systems.physics.ContactResult
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.LENGTH
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.N_POINT_FIELDS
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.POINT_0
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.POINT_1
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.RESTING_MIN_VEL
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.RESTING_STEPS_BEFORE_SLEEP
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.STIFFNESS
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.X
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.X_ACC
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.X_LAST
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.Y
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.Y_ACC
import no.njoh.pulseengine.core.scene.systems.physics.shapes.PolygonShape.Companion.Y_LAST
import kotlin.math.*
