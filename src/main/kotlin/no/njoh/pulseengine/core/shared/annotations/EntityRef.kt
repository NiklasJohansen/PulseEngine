 ...
 * Lets the editor know that the fields refer to other entities, optionally filtered
 * by an entity class or implemented interface, and handles ID mapping when copying
 * a cluster of related entities.
 */
@Target(PROPERTY, FUNCTION, PROPERTY_GETTER, ANNOTATION_CLASS)
@Retention(RUNTIME)
annotation class EntityRef(
    val type: KClass<*> = SceneEntity::class
)