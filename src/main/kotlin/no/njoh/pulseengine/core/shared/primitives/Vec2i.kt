...
package no.njoh.pulseengine.core.shared.primitives.Vec2i
...
inline fun Vec2i.vAdd(v: Vec2i): Vec2i = Vec2i(x + v.x, y + v.y)
inline fun Vec2i.vAdd(v: Int):   Vec2i = Vec2i(x + v, y + v)
inline fun Vec2i.vSub(v: Vec2i): Vec2i = Vec2i(x - v.x, y - v.y)
inline fun Vec2i.vSub(v: Int):   Vec2i = Vec2i(x - v, y - v)
inline fun Vec2i.vMul(v: Vec2i): Vec2i = Vec2i(x * v.x, y * v.y)
inline fun Vec2i.vMul(v: Int):   Vec2i = Vec2i(x * v, y * v)
inline fun Vec2i.vDiv(v: Vec2i): Vec2i = Vec2i(x / v.x, y / v.y)
inline fun Vec2i.vDiv(v: Int):   Vec2i = Vec2i(x / v, y / v)

// Array constructors
fun emptyVec2iArray(): Vec2iArray = VEC2I_EMPTY_ARRAY
fun vec2iArrayOfSize(size: Int): Vec2iArray = LongArray(size)
