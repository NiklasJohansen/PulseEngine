...
open class DirectLightingSystem2D : SceneSystem()
{
    ...
    private val normalMapRenderPass = EntityRenderPass<NormalMapped2D>(
    ...
    private fun addLightsSources(light: DirectLightSource, lightRenderer: DirectLightRenderer, lightSurface: Surface, engine: PulseEngine)
    {
        ...
        {
            engine.scene.forEach2DEntityNearbyOfType<DirectLightOccluder>(
                x = light.x,
                y = light.y,
    ...
    private fun addOccluderEdges(shape: Shape2D, lightRenderer: DirectLightRenderer, lightSurface: Surface)
    {
