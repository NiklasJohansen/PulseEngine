...
import no.njoh.pulseengine.modules.physics2d.shapes.PointShape2D
import kotlin.math.abs

interface PointBody2D : PhysicsBody2D
{
    override val shape: PointShape2D
    ...
    override fun iterateStep(engine: PulseEngine, iteration: Int, totalIterations: Int, worldWidth: Int, worldHeight: Int)
    {
        ...
        engine.scene.forEach2DEntityNearby(x, y, xVel * 2, yVel * 2)
        {
            if (it !== this &&
                it is PhysicsBody2D &&
