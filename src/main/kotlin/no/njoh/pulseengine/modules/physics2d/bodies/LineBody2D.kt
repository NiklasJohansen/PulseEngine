...
import no.njoh.pulseengine.modules.physics2d.shapes.LineShape2D
import kotlin.math.*

interface LineBody2D : PhysicsBody2D
{
    override val shape: LineShape2D
    ...
    override fun iterateStep(engine: PulseEngine, iteration: Int, totalIterations: Int, worldWidth: Int, worldHeight: Int)
    {
        ...
        engine.scene.forEach2DEntityNearby(x, y, xMax - xMin, yMax - yMin)
        {
            if (it !== this &&
                it is PhysicsBody2D &&
