...
import no.njoh.pulseengine.modules.physics2d.shapes.CircleShape2D.Companion.RESTING_MIN_VEL
import no.njoh.pulseengine.modules.physics2d.shapes.CircleShape2D.Companion.RESTING_STEPS_BEFORE_SLEEP
import kotlin.math.*

interface CircleBody2D : PhysicsBody2D
{
    ...
    private fun updateCollisions(engine: PulseEngine)
    {
        ...
        engine.scene.forEach2DEntityNearby(shape.x, shape.y, radius * 2f, radius * 2f)
        {
            if (it !== this &&
                it is PhysicsBody2D &&
